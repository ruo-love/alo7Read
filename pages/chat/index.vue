<template>
  <view class="chat-page">
    <scroll-view scroll-y="true" @scroll="socketTarget.scroll" class="scroll-Y" :scroll-top="socketTarget.scrollTop">
...
function tencentCloudApi(config, data) {
  const { authorization, timestamp, host, action, version, region, ContentType } = V3(config, data)
  return uni.request({
